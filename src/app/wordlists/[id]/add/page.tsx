...
import { ArrowLeft, Plus, X, Sparkles, Check, Edit2 } from 'lucide-react';
    ...
    const generateDetails = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (res.status === 503) {
                    setError('AI servisi için API anahtarı eksik.');
                } else {
    ...
    if (!session) {
        return (
            <div className="max-w-4xl mx-auto px-4 py-12 text-center">
                <p className="text-gray-600 mb-4">Kelime eklemek için giriş yapmalısınız</p>
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Kelime Ekle</h1>
                    <p className="text-gray-600">{wordList.name} listesine kelime ekle</p>
                </div>
            </div>
            ...
            <div className="space-y-8">
                ...
                {words.length > 0 && (
                    <div className="space-y-3">
                        <h2 className="font-semibold text-gray-900">Eklenecek Kelimeler ({words.length})</h2>
