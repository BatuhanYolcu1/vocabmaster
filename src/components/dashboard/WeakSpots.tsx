        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-slate-700">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white">Zayıf Noktalar</h3>
                </div>
                <Link
                    href="/categories"
            ...
            <div className="text-center py-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-2">Henüz yeterli veri yok</p>
