...
export const PLAN_LIMITS: Record<Plan, PlanLimits> = {
    FREE: {
        ...
        maxWordLists: 3,
        dailyAILimit: 5,
        studyModes: ['flashcard', 'multiple-choice', 'typing'],
    ...
    LITE: {
        ...
        maxWordLists: 10,
        dailyAILimit: 30,
        studyModes: ['flashcard', 'multiple-choice', 'typing', 'listening', 'matching'],
    ...
    PRO: {
        ...
        studyModes: ['flashcard', 'multiple-choice', 'typing', 'listening', 'matching', 'speaking', 'fill-blank', 'story'],
        hasDetailedStats: true,
        hasExcelImport: true,
        hasStoryMode: true,
